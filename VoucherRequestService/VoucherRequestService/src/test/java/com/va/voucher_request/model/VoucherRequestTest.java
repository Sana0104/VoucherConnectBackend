...
import org.junit.jupiter.api.Test;
 ...
 class VoucherRequestTest {
    ...
    void testConstructorAndGetters() {
        VoucherRequest voucherRequest = new VoucherRequest("1", "John Doe", "john@example.com", "AWS", "AWS Certified Developer", 80, "scoreImage", "V123", LocalDate.now(), LocalDate.now().plusMonths(1), LocalDate.now().plusMonths(2), "Pass", "certificateImage", "ValidationID", "ss");
